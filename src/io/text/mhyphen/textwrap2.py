"""Text wrapping and filling with optional hyphenation.
"""
...
# Optional hyphenation added by Dr. Leo <fhaxbox66@googlemail.com>
...
class TextWrapper:
    ...
    Several instance attributes control various aspects of wrapping:
      ...
      use_hyphenator (default: None)
          must be a hyphenator object from the package 'hyphen'.
    """
    ...
    def _wrap_chunks(self, chunks):
        ...
        while chunks:
            ...
            while chunks:
                ...
                # Nope, this line is full. But try hyphenation.
                else:
